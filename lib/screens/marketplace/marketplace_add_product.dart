...
class MarketPlaceAddProduct extends StatefulWidget {
  static String routeName = "/marketplace_add_product";
              ...
              children: [
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: url == "" ? Center(child: Text('Add Photo')) : Image.network(url) ,
                        ),
                        Padding(
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: RequiredValidator(errorText: 'Product name is required'),
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    style: TextStyle(color: Colors.black54),
                    validator: RequiredValidator(errorText: 'Product price is required'),
                    decoration: InputDecoration(
                      enabledBorder: const OutlineInputBorder(
                        // width: 0.0 produces a thin "hairline" border
                        borderSide: const BorderSide(color: Colors.black54, width: 0.0),
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    style: TextStyle(color: Colors.black54),
                    validator: RequiredValidator(errorText: 'Product description is required'),
                    decoration: InputDecoration(
                      enabledBorder: const OutlineInputBorder(
                        // width: 0.0 produces a thin "hairline" border
                        borderSide: const BorderSide(color: Colors.black54, width: 0.0),
                      ...
                      hintStyle: TextStyle(color: Colors.black54),
                      prefixIcon: Icon(CupertinoIcons.paperclip, color: Colors.black54,),
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(10),
                      ),
                    ),
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    style: TextStyle(color: Colors.black54),
                    validator: RequiredValidator(errorText: 'Product stock is required'),
                    decoration: InputDecoration(
                      enabledBorder: const OutlineInputBorder(
                        // width: 0.0 produces a thin "hairline" border
                        borderSide: const BorderSide(color: Colors.black54, width: 0.0),
                      ...
                      hintStyle: TextStyle(color: Colors.black54),
                      prefixIcon: Icon(CupertinoIcons.time, color: Colors.black54,),
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(10),
                      ),
                    ),
                ...
                SizedBox(height: 20,),
                loading ? CircularProgressIndicator() : RoundedButton(
