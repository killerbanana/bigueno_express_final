...
class MarketPlaceEditProduct extends StatefulWidget {
  final String productId;
  final Products product;
  static String routeName = "/marketplaceAddProduct";

  const MarketPlaceEditProduct({Key key, this.productId, this.product})
      : super(key: key);

  @override
  _MarketPlaceEditProductState createState() => _MarketPlaceEditProductState();
}

class _MarketPlaceEditProductState extends State<MarketPlaceEditProduct> {
