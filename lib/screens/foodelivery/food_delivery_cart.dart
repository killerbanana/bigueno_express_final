                        ...
                        trailing: Container(
                          child: SpinnerInput(
                            ...
                            onChange: (newValue) async {
                              ...
                              if (newValue == 0) {
                                dynamic result =  await _firebaseServices.deleteCart(user.uid, data['seller'], document.id);
                              } else {
                                dynamic result =  await _firebaseServices.updateCart(user.uid, data['seller'], document.id, data['product name'], newValue);
                              }
                              setState(() {});
                            },
                          ),
