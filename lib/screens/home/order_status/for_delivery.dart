...
class ForDelivery extends StatefulWidget {
  @override
  _ForDeliveryState createState() => _ForDeliveryState();
}

class _ForDeliveryState extends State<ForDelivery> {
  Users user;
  List<dynamic> cart = [];
        ...
        children: [
          StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance
                .collection('orders')
                .where('uid', isEqualTo:  user.uid).where('status', isEqualTo: "For Delivery")
                .snapshots(),
                                ...
                                TextButton(
                                  onPressed: () async {
                                    await _firebaseServices
                                        .confirmOrderReceived(document.id);
                                    
                                    await _firebaseServices.statusUpdate2(data['rider id']);
